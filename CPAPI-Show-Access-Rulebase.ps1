...
param(
	[Parameter(Mandatory=$true, HelpMessage="RuleBase Name")][String] $Rulebasename,
	[Parameter(Mandatory=$false, HelpMessage="UID")][String] $UID,
	[Parameter(Mandatory=$false, HelpMessage="Template to filter rulebase response.")][String] $filter,
	[Parameter(Mandatory=$false, HelpMessage="Format: YYYY-MM-DD, YYYY-mm-ddThh:mm:ss")][String] $hits_settings_from_date,
	[Parameter(Mandatory=$false, HelpMessage="Target gateway name or UID")][String] $hits_settings_target,
	[Parameter(Mandatory=$false, HelpMessage="Format: YYYY-MM-DD, YYYY-mm-ddThh:mm:ss.")][String] $hits_settings_to_date,
	[Parameter(Mandatory=$false, HelpMessage="Format: YYYY-MM-DD, YYYY-mm-ddThh:mm:ss.")][String] $hits_settings_to_date,
	[Parameter(Mandatory=$false, HelpMessage="Format: YYYY-MM-DD, YYYY-mm-ddThh:mm:ss.")][String] $hits_settings_to_date,
	[Parameter(Mandatory=$false, HelpMessage="Format: YYYY-MM-DD, YYYY-mm-ddThh:mm:ss.")][String] $hits_settings_to_date,
    [Parameter(Mandatory=$false, HelpMessage="No more than that many results will be returned")][ValidateRange(1,500)][Int] $limit,
...
$myShowHostsURI="https://${myCPSmartCenterIPAddress}/web_api/show-access-rulebases"
